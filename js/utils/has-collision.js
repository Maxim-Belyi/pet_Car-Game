function hasCollision(elem1Info, elem2Info) {
    ...
    const elem1XLeft = elem1Info.coords.x - elem1Info.width * 0.3; //* 0.5
    const elem1XRight = elem1Info.coords.x + elem1Info.width * 0.3; //* 0.5

    const elem2YTop = elem2Info.coords.y;
    const elem2YBottom = elem2Info.coords.y + elem2Info.height;

    const elem2XLeft = elem2Info.coords.x - elem2Info.width * 0.5; //* 0.5
    const elem2XRight = elem2Info.coords.x + elem2Info.width * 0.5; //* 0.5
